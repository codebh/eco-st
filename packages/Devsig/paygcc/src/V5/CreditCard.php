...
class CreditCard extends PaygccCurl
{
    ...
    protected $checkout_url         = "https://api.paygcc.com/api/v5/checkout";
    protected $tokenization_url     = "https://api.paygcc.com/api/v5/customer/tokenizations";
    protected $generate_token_url   = "https://api.paygcc.com/api/v5/generateToken";
    protected $delete_token_url     = "https://api.paygcc.com/api/v5/deleteToken";

    protected $authorize_url        = "https://api.paygcc.com/api/v3/authorize";
