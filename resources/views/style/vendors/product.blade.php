                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item " aria-current="page">{{trans('user.shops')}}</li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            ...
                            <div><img src="{{asset('storage/product/'.$product->main_image)}}" alt=""
                                      class="img-fluid blur-up lazyload image_zoom_cls-0"></div>

                            @foreach ($product->image_data()->get() as $image)

                                <div><img src="{{asset('storage/product/'.$image->image_key)}}" alt=""
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            ...
                            <h5 class="mb-2">by <a href="#">{{$product->store->name}}</a></h5>
                            @if ($product->price_offer >0 and $product->status=='active')

                            <h4>
                                <del>{{presentPrice($product->price)}}</del>
                                <span>55% off</span></h4>
                            <h3>{{presentPrice($product->price_offer)}}</h3>
                            @else

                            <h3>{{presentPrice($product->price_offer)}}</h3>
                            @endif
                            <ul class="color-variant">
                                @foreach ($product->other_data()->get() as $color)

                                <li style="background-color: {{$color->color->color}}" ></li>
                                @endforeach
