                    ...
                    <div class="col-lg-6">
                        <div class="product-slick">
                            ...
                            @foreach($product->image_data()->get() as $image)
                                ...
                                <div><img src="{{imageDo($image->image_key)}}" alt=""
                                          class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                            @endforeach
                    ...
                    <div class="team-4">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="{{ route('all-products.show',$item->title) }}"><img
                    ...
                    <div class="team-4">
                        @foreach ($mightAlsoLike as $item )
                            ...
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{ route('all-products.show',$item->title) }}"><img src="{{imageDo($item->main_image)}}"
                                                         class="img-fluid blur-up lazyload " alt=""></a>
                                    </div>
