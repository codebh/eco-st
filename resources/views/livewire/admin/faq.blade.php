        ...
        <div class="card-body table-responsive p-0">
          <table class="table table-hover text-nowrap">
            ...
            <tr wire:sortable.item="{{ $product->id }}" wire:key="product-{{ $product->id }}">
                ...
                <td>{{ $product->lang }}</td>
                <td><a class="btn btn-info" href="{{ route('faq.edit',$product->id) }}"><i class="fas fa-edit    "></i></a></td>

                    <td><a class="btn btn-danger" href="{{ '/admin/faq/'.$product->id }}"><i class="fas fa-trash    "></i></a></td>
