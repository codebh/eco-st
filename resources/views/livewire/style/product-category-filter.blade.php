            ...
            <div class="col-sm-12">
                <div class="top-banner-wrapper">
                     ...
                     <div class="top-banner-content small-section">
                         <h5>{{session('lang') =='ar'?$category->name_ar:$category->name_en  }}</h5>
                                <p class="text-justify">
                                        {{session('lang') =='ar'?$category->des_ar:$category->des_en  }}
                                 </p>
                       </div>
                </div>
                                ...
                                <div class="col-xl-3 col-6 col-grid-box">
                                    <div class="product-box">
                                        ...
                                        @if ($loop->first)
                                            ...
                                            <div class="back">
                                                <a href="{{ route('all-products.show',$product->title) }}"><img src="{{imageDo($image->image_key)}}"
                                                                 class="img-fluid blur-up lazyload "
                                                                 alt=""></a>
                                            </div>
                                            @endif
                                        ...
                                        <div class="product-detail">
                                            <div class="detail-inline">
                                                ...
                                                @if ($product->price_offer > 0 and $product->status =='active')
                                                    ...
                                                    <h4 style="font-size: 13px;"> {{presentPrice($product->price_offer)}}
                        ...
                        <div class="theme-paggination-block">
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    ...
                                    {{ $productsCategory->onEachSide(1)->links('vendor.livewire.bootstrap') }}
                                </div>
