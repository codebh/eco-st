                                                                                            ...
                                                                                            <table class="table table-bordered">
                                                                                                ...
                                                                                                @foreach ($cart_content as $item )
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        @if ($loop->first)
                                                                                                            <td class="text-center" rowspan="{{$cart_count}}">{{presentPrice(0.900)}}</td>
                                                                                                        @endif
                                                                                                    </tr>
                                                                                                @endforeach
                                                                                                <tr>
                                                                                                    <td colspan="2"  scope="row">{{ trans('user.delivery') }}</td>
                                                                                                    <td colspan="1"  scope="row">{{presentPrice(0.900)}}</td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        @else
                                                                                            ...
                                                                                            <table class="table table-bordered">
                                                                                                ...
                                                                                                @foreach ($cart_content as $item )
                                                                                                    <tr>
                                                                                                        <td scope="row">{{$loop->iteration}}</td>
                                                                                                        <td>{{$item->product->title}}</td>
                                                                                                        <td >{{presentPrice(0.900)}}</td>
                                                                                                    </tr>
                                                                                                @endforeach
                                                                                                <tr>
                                                                                                    <td colspan="2"  scope="row">{{ trans('user.delivery') }}</td>
                                                                                                    <td colspan="1"  scope="row">{{presentPrice(0.900*$cart_count)}}</td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        @endif
