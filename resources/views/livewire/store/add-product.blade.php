        ...
        <div class="card-body">
            ...
            @if($currentStep == 1)
                <!-- Button trigger modal -->
                    ...
                    {{-- <small for="" class="text-danger"> {{ trans('shop.error_image') }}</small> --}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <small>{{ session('lang')== 'ar'?'يمكنك تحميل أكثر من صورة واحدة':'You can select multiple images  ' }} </small>
                            </div>
                        </div>
...
<hr>
                            ...
                            <div class="row mt-3">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox1" name="sizes_abaya" wire:model="sizes_abaya" value="a_size1">
                                                <label for="customCheckbox1" class="custom-control-label">{{trans('shop.size1')}}</label>
                                            </div>

                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox2" name="sizes_abaya" wire:model="sizes_abaya" value="a_size2">
                                                <label for="customCheckbox2" class="custom-control-label">{{trans('shop.size2')}}</label>
                                            </div>

                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox3" name="sizes_abaya" wire:model="sizes_abaya" value="a_size3">
                                                <label for="customCheckbox3" class="custom-control-label">{{trans('shop.size3')}}</label>
                                            </div>

                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox4" name="sizes_abaya" wire:model="sizes_abaya" value="a_size4">
                                                <label for="customCheckbox4" class="custom-control-label">{{trans('shop.size4')}}</label>
                                            </div>

                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox5" name="sizes_abaya" wire:model="sizes_abaya" value="a_size5">
                                                <label for="customCheckbox5" class="custom-control-label">{{trans('shop.size5')}}</label>
                                            </div>

                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox6" name="sizes_abaya" wire:model="sizes_abaya" value="a_size6">
                                                <label for="customCheckbox6" class="custom-control-label">{{trans('shop.size6')}}</label>
                                            </div>
                                         </div>
                                ...
                                <div class="col-md-8 product-image-thumbs">
                                    <div class="product-image-thumb active" data-toggle="modal" data-target="#img_size">
                                        <img src="{{asset('img/a_small_abaya.jpeg')}}" alt="Product Image">
                                    </div>
                                </div>


                <div id="img_size" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="{{asset('img/a_small_abaya.jpeg')}}" style="width:300px" alt="Product Image">
                                    </div>
                                </div>
                            </div>
...
@foreach ($this->size_qty as $item1)
