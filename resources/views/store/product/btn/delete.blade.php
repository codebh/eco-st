...
<div id="del_admin{{$id}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['showShop.destroy',$id],'method'=>'delete']) !!}
            <div class="modal-body">
                <h4>{{trans('admin.delete_this').$title }}</h4>
{{--                <h4>{{trans('admin.delete_this',['name'=>session('lang')== 'ar'?$name_ar:$name_en]).$name_ar }}</h4>--}}
            </div>
