            ...
            <div class="row">
                <div class="col-8">
                    <div class="form-group">
                        ...
                        {!! Form::select('color',App\Models\Color::pluck('name_ar','id') ,old('color'),['class'=>'form-control select2']) !!}
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <label for="activeRadio1" class="custom-control-label">  <h5>تفعيل المنتج</h5> </label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input custom-control-input-danger" value="not active" type="radio" id="activeRadio2" name="show" >
                            <label for="activeRadio2" class="custom-control-label"><h5>غير مفعل</h5></label>
                        </div>
                    </div>
