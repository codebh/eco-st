    ...
    <body>
        <header>
            <div style="position:absolute; left:0pt; width:250pt;">
                <img class="img-rounded" height="{{ $invoice->logo_height }}" src="{{ asset('img/theme/logo/logo03.png') }}">
            </div>
                ...
                <div style="margin-left: 300pt;">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            @if ($invoice->customer_details->get('country') == 'bahrain')
                            BUILDING: {{ $invoice->customer_details->get('home') }}<br />
                            ROAD: {{ $invoice->customer_details->get('road') }}<br />
                            BLOCK: {{ $invoice->customer_details->get('block') }}<br />
                            SPECIAL DIRECTION: {{ $invoice->customer_details->get('special direction') }}<br />
                            @else
                            PROVINCE: {{ $invoice->customer_details->get('province') }}<br />
                            ADDRESS: {{ $invoice->customer_details->get('address') }}<br />
                            ADDRESS 2: {{ $invoice->customer_details->get('address2') }}<br />
                            ZIP: {{ $invoice->customer_details->get('zip') }}<br />
                            @endif
