            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        {{--<img src="{{asset('img/size.png')}}" class="product-image" alt="">--}}
                        ...
                        <div class="card card-outline card-warning">
                            ...
                            <div class="card-body">
                                <div class="col">
                                    <div class="text-center">
                                        {{--product-image{}--}}
                                        <img src="{{asset('img/a_size.jpeg')}}" class="img-fluid" alt="">
                        ...
                        <div class="card card-outline card-success">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="info-box bg-warning">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">{{$order->order->billing_address}}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    {{--                                    <div class="col-12 col-sm-2">--}}
                                    {{--                                        <div class="info-box bg-warning">--}}
                                    {{--                                            <span class="info-box-icon"><i class="fa fa-fill-drip"--}}
                                    {{--                                                                           style="color: {{$order->product->color->color}}"></i></span>--}}
                                    {{--                                            <div class="info-box-content">--}}
                                    {{--                                                <span class="info-box-text">{{trans('shop.color_id')}}</span>--}}
                                    {{--                                                <span class="info-box-number">--}}
                                    {{--                                @if(direction()=='ltr')--}}
                                    {{--                                                        {{$order->product->color->name_en}}--}}
                                    {{--                                                    @else--}}
                                    {{--                                                        {{$order->product->color->name_ar}}--}}
