...
<head>
    ...
    <link rel="stylesheet" href="{{asset('design/admin/dist/css/animate.css')}}">
    <link rel="stylesheet"
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="{{asset('design/admin/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
    <!-- Toastr -->
    <link rel="stylesheet" href="{{asset('design/admin/plugins/toastr/toastr.min.css')}}">
    <!-- Select2 -->
...
@if(direction()=='ltr')
    ...
    @else
        ...
        <link rel="stylesheet" href="{{asset('design/admin/rtl/adminlte.css')}}">
        <link rel="stylesheet" href="{{asset('design/admin/rtl/bootstrap-rtl.min.css')}}">
        <link rel="stylesheet" href="{{asset('design/admin/rtl/custom-style.css')}}">
