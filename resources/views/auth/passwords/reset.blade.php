                    ...
                    <h2>{{trans('user.forget_your_password')}}</h2>
                        ...
                        <form method="POST"  action="{{ route('password.update') }}" class="theme-form">
                            ...
                            <div class="col-md-12">
                                ...
                                @error('email')
                                <label for="" >     <strong class="text-danger">{{ $message }}</strong></label>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-12">
                                    <label for="">{{trans('user.confirm_password')}}</label>
                                ...
                                <button type="submit" class="btn btn-solid w-auto">{{trans('user.submit')}}</button>
